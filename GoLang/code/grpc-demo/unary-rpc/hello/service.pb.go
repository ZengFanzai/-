...
func init() {
	...
	proto.RegisterType((*HelloReply)(nil), "service1.HelloReply")
}
...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0xcb, 0x4c, 0x4e, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x80, 0x72, 0x0d, 0x95, 0x94,
	...
	0xb5, 0x48, 0xc8, 0x8a, 0x8b, 0x23, 0x38, 0xb1, 0x12, 0xac, 0x4d, 0x48, 0x4c, 0x0f, 0x66, 0x9d,
	0x1e, 0xb2, 0x5d, 0x52, 0x22, 0x18, 0xe2, 0x05, 0x39, 0x95, 0x4a, 0x0c, 0x42, 0xf6, 0x5c, 0xbc,
	0x30, 0xbd, 0x8e, 0xe9, 0x89, 0x99, 0x79, 0xa4, 0x1a, 0x90, 0xc4, 0x06, 0xf6, 0xa5, 0x31, 0x20,
	0x00, 0x00, 0xff, 0xff, 0x2e, 0x87, 0xb0, 0xf2, 0xf6, 0x00, 0x00, 0x00,
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/service1.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/service1.Greeter/SayHelloAgain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service1.Greeter/SayHello",
	}
...
func _Greeter_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service1.Greeter/SayHelloAgain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
