...
# 查看文件列表，可以指定-r查看，查看指定版本号得文件列表
svn ls
svn -r 100

# 显示文件的每一行最后是谁修改的(出了BUG，经常用来查这段代码是谁修改的)
...
# 若想创建一个文件夹，并且把它加入版本控制，但忽略文件夹中的所有文件的内容
svn mkdir spool
...
> - [3 分钟练成 SVN 命令高手：SVN 常用命令](https://juejin.im/post/5ae3e699f265da0b715605ad)
